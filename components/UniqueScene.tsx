...
export function UniqueScene({
  ...
  return (
    ...
    >
      ...
      {kind === 14 && (
        <>
          <rect x="36" y="36" width="248" height="100" rx="8" fill="#05080a" />
      ...
      {mark === "ledger" && (
        <g transform="translate(248,30)">
          <rect width="40" height="32" rx="4" fill="#05080a" stroke={p.c} />
      ...
      <rect x="12" y="154" width="296" height="24" rx="0 0 10 10" fill="#05080a" fillOpacity="0.96" />
      <text
        x="22"
        y="170"
        fill="#ffffff"
